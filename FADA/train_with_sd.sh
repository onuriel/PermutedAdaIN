...
python -m torch.distributed.launch --nproc_per_node=$NGPUS train_src.py -cfg configs/deeplabv2_r101_src.yaml OUTPUT_DIR results/src_r101_padain_pretrained_0.01/
# train with fine-grained adversarial alignment
python -m torch.distributed.launch --nproc_per_node=$NGPUS train_adv.py -cfg configs/deeplabv2_r101_adv.yaml OUTPUT_DIR results/adv_test resume results/src_r101_padain_pretrained_0.01/model_iter020000.pth
