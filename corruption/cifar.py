...
def main():
  ...
  if args.model == 'densenet':
    net = densenet(num_classes=num_classes, with_permute_adain=args.padain>0, p_adain=args.padain)
  elif args.model == 'resnext':
    net = resnext29(num_classes=num_classes, with_permute_adain=args.padain>0, p_adain=args.padain)
